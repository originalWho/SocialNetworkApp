...
extension UIViewController {
    ...
    struct Constants {
        ...
        struct WarningMessage {
            ...
            static let NotChosenCountry = "Country is not chosen"
            static let NotChosenBirthday = "Birthday is not chosen"
            static let NotChosenMotherLanguage = "Mother language is not chosen"
        }
